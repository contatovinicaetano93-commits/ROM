...
/** Campos que vêm do Avec — recompute ROM nunca sobrescreve. */
export type AvecMetricsPatch = Pick<
  SalonMetricsPatch,
  'revenue' | 'attended' | 'no_shows' | 'cancelled' | 'ticket_avg'
>

/** Campos calculados só pelo ROM. */
export type RomMetricsPatch = Pick<SalonMetricsPatch, 'appointments' | 'new_clients' | 'returning_clients'>
